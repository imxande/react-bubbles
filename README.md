...
- Tokens are issued by the server and client can use it    as a permission to access protected resources.

- [x] What steps can you take in your web apps to keep your data secure?

-  Add protected routes that will need an authorization     token to have access.

- [x] Describe how web servers work.

-  A web server process incoming network request over       HTTP and several other protocols. Web server store       and deliver web pages to clients.
